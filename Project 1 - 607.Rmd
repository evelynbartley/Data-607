...
```{r}
chessF$Round1 <- as.numeric(chessF$Round1)
chessF$Round2 <- as.numeric(chessF$Round2)
chessF$Round3 <- as.numeric(chessF$Round3)
chessF$Round4 <- as.numeric(chessF$Round4)
chessF$Round5 <- as.numeric(chessF$Round5)
chessF$Round6 <- as.numeric(chessF$Round6)
chessF$Round7 <- as.numeric(chessF$Round7)
chessF$PreRating <- as.numeric(chessF$PreRating)
```
...
x <- chessF$Round1
for (i in chessF){
  x <- chessF$PreRating[x]
}
```
Ideally, I would have been able to run this for loop for Rounds 1-7, and end up with the prerating scores for each of the opponents instead of their ID number.
...
```{r}
write_csv(chessF, 'chessFinal.csv', append = FALSE)
```
